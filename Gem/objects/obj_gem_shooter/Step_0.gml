...
if (y < 256)//todo: fix to place in the middle without bouncing out of bounds
{
	vspd = 0;
	y = room_height div 2;
	var inst = instance_create_layer(x,y,"Instances",obj_gem);
...
if (vspd == 0)
{
	lane_change = keyboard_check_pressed(vk_right) - keyboard_check_pressed(vk_left);
	lane = clamp(lane + lane_change,0,9);
}